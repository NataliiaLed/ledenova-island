...
import static com.ledenova.island.config.OrganismClass.HORSE;

@Actor(HORSE)
public class Horse extends AbstractAnimal{
    public Horse(Configuration configuration, String name, Board board, OrganismFactory organismFactory) {
        super(configuration, name, HORSE, board, organismFactory);
    }
}
