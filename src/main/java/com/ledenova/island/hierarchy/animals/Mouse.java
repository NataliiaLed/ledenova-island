...
import static com.ledenova.island.config.OrganismClass.MOUSE;

@Actor(MOUSE)
public class Mouse extends AbstractAnimal{
    public Mouse(Configuration configuration, String name, Board board, OrganismFactory organismFactory) {
        super(configuration, name, MOUSE, board, organismFactory);
