...
import static com.ledenova.island.config.OrganismClass.BEAR;

@Actor(BEAR)
public class Bear extends AbstractAnimal{
    public Bear(Configuration configuration, String name, Board board, OrganismFactory organismFactory) {
        super(configuration, name, BEAR, board, organismFactory);
    }
}
