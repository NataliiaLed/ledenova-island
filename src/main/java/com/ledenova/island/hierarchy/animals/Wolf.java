...
import static com.ledenova.island.config.OrganismClass.WOLF;

@Actor(WOLF)
public class Wolf extends AbstractAnimal{
    public Wolf(Configuration configuration, String name, Board board, OrganismFactory organismFactory) {
        super(configuration, name, WOLF, board, organismFactory);
    }
}
