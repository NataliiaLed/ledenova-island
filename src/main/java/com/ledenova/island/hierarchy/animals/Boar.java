...
import static com.ledenova.island.config.OrganismClass.BOAR;

@Actor(BOAR)
public class Boar extends AbstractAnimal{
    public Boar(Configuration configuration, String name, Board board, OrganismFactory organismFactory) {
        super(configuration, name, BOAR, board, organismFactory);
    }
}
