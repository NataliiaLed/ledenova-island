...
import static com.ledenova.island.config.OrganismClass.BUFFALO;

@Actor(BUFFALO)
public class Buffalo extends AbstractAnimal{
    public Buffalo(Configuration configuration, String name, Board board, OrganismFactory organismFactory) {
        super(configuration, name, BUFFALO, board, organismFactory);
    }
}
