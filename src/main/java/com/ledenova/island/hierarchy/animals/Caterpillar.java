...
import static com.ledenova.island.config.OrganismClass.CATERPILLAR;

@Actor(CATERPILLAR)
public class Caterpillar extends AbstractAnimal{
    public Caterpillar(Configuration configuration, String name, Board board, OrganismFactory organismFactory) {
        super(configuration, name, CATERPILLAR, board, organismFactory);
    }
}
