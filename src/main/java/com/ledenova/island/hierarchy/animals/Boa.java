...
import static com.ledenova.island.config.OrganismClass.BOA;

@Actor(BOA)
public class Boa extends AbstractAnimal{
    public Boa(Configuration configuration, String name, Board board, OrganismFactory organismFactory) {
        super(configuration, name, BOA, board, organismFactory);
    }
}
